...
@COLLATE_FUNCTIONS.register_module()
def yolo6d_collate(data_batch: Sequence,
                   use_ms_training: bool = False) -> dict:
    """Rewrite collate_fn to get faseter training speed"""
    
    batch_imgs = []
    batch_cpts_confs_labels = []
    ...
    collated_results = {
        'data_samples': {
            'cpts_confs_labels': torch.cat(batch_cpts_confs_labels, 0)
        }
    }
